...
//			throwHazard("MEM Hazard 1 ");
//			ID_EX.forwardA = "01" ;	
//		}
//		 if( registersWriteControl == 1 && !MemoryStage.forwardingInput.equals("0")  && MemoryStage.forwardingInput.equals(ID_EXRegisterRt) ) {
//			throwHazard("MEM Hazard 2");
//			ID_EX.forwardB = "01" ;	
//		}
		 
		 if(registersWriteControl == 1 &&
				 !MemoryStage.forwardingInput.equals("0")&&
				 !(EX_MEM.registerWrite != 0 && !MemoryStage.forwardingInput.equals("0"))&&
				 	!EX_MEM.DestinationRegister.equals(ID_EXRegisterRs)&&
				 	EX_MEM.DestinationRegister.equals(ID_EXRegisterRs)) {
			 ID_EX.forwardA = "01" ;
		 }
		 ...
		 if(registersWriteControl == 1 &&
				 !MemoryStage.forwardingInput.equals("0")&&
				 !(EX_MEM.registerWrite != 0 && !MemoryStage.forwardingInput.equals("0"))&&
				 	!EX_MEM.DestinationRegister.equals(ID_EXRegisterRt)&&
				 	EX_MEM.DestinationRegister.equals(ID_EXRegisterRt)) {
			 ID_EX.forwardB = "01" ;
		 }
